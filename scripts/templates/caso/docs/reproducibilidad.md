...
- Dependencias: `repos/SimulacionClimatica/requirements.txt`
...
python3 -m pip install -r repos/SimulacionClimatica/requirements.txt

# Ejecutar validación (si existe código ejecutable)
python3 scripts/tesis.py validate --case caso_{{case_name}}

# O directamente
python3 repos/SimulacionClimatica/02_Modelado_Simulacion/caso_{{case_name}}/src/validate.py
```
