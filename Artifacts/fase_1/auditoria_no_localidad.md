...
## Resumen
- No-localidad estaba mapeada a centralidad distribuida pero sin métrica adicional explícita. - Casos de finanzas no incluían verificación explícita de dispersión causal.
