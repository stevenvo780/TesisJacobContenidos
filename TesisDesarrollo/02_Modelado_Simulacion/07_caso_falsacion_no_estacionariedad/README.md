# Caso Falsación: No Estacionariedad (Modelo y Simulación)

**Nivel de cierre operativo:** —
**Estado:** 🔬 Control negativo (falsación)
**Generado:** 2026-02-09T20:20:01.386138
...
```bash
cd repos/Simulaciones/07_caso_falsacion_no_estacionariedad/src && python3 validate.py
```
...
|---------|-----------|------|
| EDI     | N/A | -1.000 |
| IC 95%  | N/A | [-5.639, -4.178] |
| Corr ABM | N/A | 0.9949 |
| Corr ODE | N/A | 0.9670 |
| CR (Symploké) | N/A | 1.0043 |
| RMSE ABM | N/A | 3.133 |
| overall_pass | — | ❌ |
...
**Sensibilidad al ruido:** estable=✅, CV=0.0006
