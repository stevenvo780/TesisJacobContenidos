# Validacion C1–C5 — Deforestacion Global
...
- Datos reales: World Bank API — `AG.LND.FRST.ZS` (1990–2022).
...
- Sensibilidad al forcing: el modelo debe responder coherentemente
  a cambios en la presion de deforestacion.
- Coherencia con datos del dominio (tasas de deforestacion observadas).
