# Reproducibilidad y Versionado — Mega-constelaciones Satelitales (Starlink)
...
```
repos/Simulaciones/26_caso_starlink/
├── src/
...
│   └── data.py        # Obtención de datos (Datos públicos de despliegue Starlink (satélites operativos mensuales))
├── outputs/
...
## Ejecución
```bash
cd repos/Simulaciones/26_caso_starlink/src
python3 validate.py
```
