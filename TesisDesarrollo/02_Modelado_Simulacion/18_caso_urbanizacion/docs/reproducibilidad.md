# Reproducibilidad y Versionado — Urbanizacion Global
...
## Fuente de datos
- World Bank API: indicador `SP.URB.TOTL.IN.ZS` (% poblacion urbana).
...
## Ejecucion
- Comando unico: `cd repos/Simulaciones/caso_urbanizacion/src && python3 validate.py`
