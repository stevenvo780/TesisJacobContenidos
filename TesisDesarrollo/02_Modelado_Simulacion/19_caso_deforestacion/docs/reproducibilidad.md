# Reproducibilidad y Versionado — Deforestacion Global
...
## Fuente de datos
- World Bank API: indicador `AG.LND.FRST.ZS` (% area forestal).
...
## Ejecucion
- Comando unico: `cd repos/Simulaciones/caso_deforestacion/src && python3 validate.py`
