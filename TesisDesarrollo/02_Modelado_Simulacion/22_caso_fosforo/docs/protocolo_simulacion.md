# Protocolo de Simulación — Ciclo del Fósforo

## 1. Definición de escenario
- Objetivo: evaluar si alteración global del ciclo biogeoquímico del fósforo exhibe clausura operativa
  medible a través del protocolo C1–C5.
- Variable objetivo: P (carga global de fósforo reactivo).
- Indicador empírico: `AG.CON.FERT.ZS (Fertilizer consumption kg/ha of arable land)`.
- Fuente: World Bank — AG.CON.FERT.ZS (consumo de fertilizantes, kg/ha).
...
1. Obtener datos de World Bank — AG.CON.FERT.ZS (consumo de fertilizantes, kg/ha).
...
- **ODE**: α (tasa de acumulación, ~0.07), β (secuestro, ~0.02).
