...
def fetch_fossil_fuel_energy(cache_path, country="WLD", start_year=1960, end_year=2022, refresh=False):
    """Obtiene Fossil fuel energy consumption (% total, proxy producción plástico) del World Bank."""
