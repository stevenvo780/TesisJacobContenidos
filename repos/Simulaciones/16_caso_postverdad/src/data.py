"""
data.py — Postverdad y Desinformación
Genera datos con dinámica macro realista para dominio: Informacional.
...
def fetch_data(cache_path=None, start_date=None, end_date=None, refresh=False):
    if cache_path and not refresh:
        if os.path.exists(cache_path):
            ...
            return df, {"source": "cache", "domain": "Informacional"}
    ...
    return df, {"source": "synthetic_calibrated", "domain": "Informacional", "snr": float(signal_std / meas_noise)}
