"""
data.py — Ecosistema IoT Global
Datos sintéticos con dinámica macro y tendencia para dominio: Tecnológico.
...
def fetch_data(cache_path=None, start_date=None, end_date=None, refresh=False):
    ...
    if cache_path and not refresh:
        if os.path.exists(cache_path):
            ...
            return df, {"source": "cache", "domain": "Tecnológico"}
    ...
    return df, {"source": "synthetic_calibrated", "domain": "Tecnológico", "snr": float(signal_std / meas_noise)}
