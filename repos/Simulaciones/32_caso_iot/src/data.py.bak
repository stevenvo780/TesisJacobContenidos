...
def fetch_mobile_subscriptions(cache_path, country="WLD", start_year=1960, end_year=2022, refresh=False):
    """Obtiene Mobile cellular subscriptions (per 100 people) del World Bank."""
