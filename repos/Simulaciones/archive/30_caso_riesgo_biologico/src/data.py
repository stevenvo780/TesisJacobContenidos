...
def fetch_mortality_rate(cache_path, country="WLD", start_year=1960, end_year=2022, refresh=False):
    """Obtiene Mortality rate, under-5 (per 1,000 live births) del World Bank."""
