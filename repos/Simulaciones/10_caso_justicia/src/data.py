"""
data.py — Justicia Algorítmica
Genera datos con dinámica macro realista para dominio: Sociotécnico.
...
def fetch_data(cache_path=None, start_date=None, end_date=None, refresh=False):
    if cache_path and not refresh:
        if os.path.exists(cache_path):
            ...
            return df, {"source": "cache", "domain": "Sociotécnico"}
    ...
    return df, {"source": "synthetic_calibrated", "domain": "Sociotécnico", "snr": float(signal_std / meas_noise)}
