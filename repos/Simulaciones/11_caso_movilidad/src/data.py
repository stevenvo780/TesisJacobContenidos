"""
data.py — Movilidad Urbana Emergente
Genera datos con dinámica macro realista para dominio: Movilidad.
...
def fetch_data(cache_path=None, start_date=None, end_date=None, refresh=False):
    if cache_path and not refresh:
        if os.path.exists(cache_path):
            ...
            return df, {"source": "cache", "domain": "Movilidad"}
    ...
    return df, {"source": "synthetic_calibrated", "domain": "Movilidad", "snr": float(signal_std / meas_noise)}
