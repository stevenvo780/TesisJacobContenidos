"""
data.py — Erosión Dialéctica
Genera datos con dinámica macro realista para dominio: Dialéctico.
...
def fetch_data(cache_path=None, start_date=None, end_date=None, refresh=False):
    if cache_path and not refresh:
        if os.path.exists(cache_path):
            ...
            return df, {"source": "cache", "domain": "Dialéctico"}
    ...
    return df, {"source": "synthetic_calibrated", "domain": "Dialéctico", "snr": float(signal_std / meas_noise)}
