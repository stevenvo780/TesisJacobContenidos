...
def fetch_internet_users(cache_path, country="WLD", start_year=1960, end_year=2022, refresh=False):
    """Obtiene Individuals using the Internet (% of population) del World Bank."""
