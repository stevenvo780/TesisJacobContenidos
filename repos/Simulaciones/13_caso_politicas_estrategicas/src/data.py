"""
data.py — 13_caso_politicas_estrategicas
...
def fetch_data(cache_path=None, start_date=None, end_date=None, refresh=False):
    ...
    if cache_path and not refresh and os.path.exists(cache_path):
        ...
        return df, {"source": "cache", "case": "13_caso_politicas_estrategicas"}

    df, meta = fetch_case_data("13_caso_politicas_estrategicas", start_date, end_date, cache_path=cache_path)
